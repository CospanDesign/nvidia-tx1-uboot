...
#include "pinmux-config-mit-uav-revb.h"
...
void pinmux_init(void)
{
	...
	gpio_config_table(mit_uav_revb_gpio_inits,
			  ARRAY_SIZE(mit_uav_revb_gpio_inits));

	pinmux_config_pingrp_table(mit_uav_revb_pingrps,
				   ARRAY_SIZE(mit_uav_revb_pingrps));

	pinmux_config_drvgrp_table(mit_uav_revb_drvgrps,
				   ARRAY_SIZE(mit_uav_revb_drvgrps));
}
