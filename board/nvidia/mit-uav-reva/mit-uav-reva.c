...
#include "pinmux-config-mit-uav-reva.h"
...
void pinmux_init(void)
{
	...
	gpio_config_table(mit_uav_reva_gpio_inits,
			  ARRAY_SIZE(mit_uav_reva_gpio_inits));

	pinmux_config_pingrp_table(mit_uav_reva_pingrps,
				   ARRAY_SIZE(mit_uav_reva_pingrps));

	pinmux_config_drvgrp_table(mit_uav_reva_drvgrps,
				   ARRAY_SIZE(mit_uav_reva_drvgrps));
}
