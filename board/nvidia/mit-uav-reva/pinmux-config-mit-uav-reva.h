 ...
 * Run "board-to-uboot.py mit-uav-reva".
 */

#ifndef _PINMUX_CONFIG_MIT_UAV_REVA_H_
#define _PINMUX_CONFIG_MIT_UAV_REVA_H_
...
static const struct tegra_gpio_config mit_uav_reva_gpio_inits[] = {
	/*        port, pin, init_val */
	GPIO_INIT(A,    5,   IN),
	GPIO_INIT(B,    0,   IN),
	GPIO_INIT(B,    1,   IN),
...
static const struct pmux_pingrp_config mit_uav_reva_pingrps[] = {
...
static const struct pmux_drvgrp_config mit_uav_reva_drvgrps[] = {
};

#endif /* PINMUX_CONFIG_MIT_UAV_REVA_H */
